...
const api = {
  ...
  resumeRun: (input: unknown) => ipcRenderer.invoke('runs:resume', input),
  openRunTerminal: (worktreePath: string, sessionId: string) => ipcRenderer.invoke('runs:openTerminal', worktreePath, sessionId),
